  ...
  return (
    <section id="contact" className="py-24 px-6">
      <div className="max-w-content mx-auto">
        <h2 className="text-2xl font-semibold text-ink-light dark:text-ink-dark mb-4">
          Let&apos;s connect
        </h2>
        <p className="text-base text-muted mb-10 leading-relaxed">
          I&apos;m always open to interesting projects or opportunities. Reach out via email
